...
export default function CheckoutPage() {
  ...
  const handlePayWithPayFast = async () => {
    ...
    try {
      ...
      /* Set PayFast form data — useEffect will auto-submit */
  ...
  return (
    <div style={{ background: C.bg, minHeight: "100vh", paddingBottom: 40 }}>
      ...
      {/* Hidden PayFast form — auto-submits when pfData is set */}
      {pfData && pfUrl && (
      ...
      <div style={{ padding: "20px 16px" }}>
        ...
        {step === 3 && (
          <div>
            <div style={{ fontSize: 16, fontWeight: 700, color: C.dark, marginBottom: 16 }}>💳 Pay with PayFast</div>
            ...
            >
              {busy ? "Preparing payment…" : `🔒 Pay R${grandTotal.toFixed(2)} with PayFast`}
            </button>
